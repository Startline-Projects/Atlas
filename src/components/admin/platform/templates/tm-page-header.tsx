/* admin.html lines 62392-62414: fr-page-head pattern — title + meta line (with inline meta-pulse) + search + 2 actions */

import { TmMetaPulse } from './tm-meta-pulse';
import type { TmHeaderAction } from '@/lib/mock-data/admin/templates-data';
    ...
    <div className="flex items-start justify-between gap-[20px] mb-[18px] flex-wrap">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="font-mono text-[11px] text-[var(--ink-mute)] tracking-[0.02em] leading-[1.5] flex items-center flex-wrap">
          <span>{metaText}</span>
          <TmMetaPulse html={metaPulseHtml} />
        </div>
      </div>

      {/* Right: search + 2 actions */}
