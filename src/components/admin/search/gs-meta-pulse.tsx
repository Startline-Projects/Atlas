/* admin.html line 67508: meta-pulse alert inline in fr-page-head meta line (danger-tinted pulsing dot) */

interface GsMetaPulseProps {
  html: string;
}

export function GsMetaPulse({ html }: GsMetaPulseProps) {
  return (
