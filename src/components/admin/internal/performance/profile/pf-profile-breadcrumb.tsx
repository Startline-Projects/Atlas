/* Profile breadcrumb — Performance dashboards › All specialists › Daniel Park · spec-001 */

import Link from 'next/link';
import type { PfProfileBreadcrumbItem } from '@/lib/mock-data/admin/performance-data';

interface PfProfileBreadcrumbProps {
  items: PfProfileBreadcrumbItem[];
}

export function PfProfileBreadcrumb({ items }: PfProfileBreadcrumbProps) {
  return (
