/* Profile 4-col stat strip — hand-translated from Step 33 hc-detail-stats pattern. */

import type { PfProfileStat } from '@/lib/mock-data/admin/performance-data';

interface PfProfileStatsProps {
  stats: PfProfileStat[];
}

export function PfProfileStats({ stats }: PfProfileStatsProps) {
  return (
...
function StatCell({ stat }: { stat: PfProfileStat }) {
  const valueColor =
