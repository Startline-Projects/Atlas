/* admin.html lines 65133-65139: fr-breadcrumb pattern (3 segments) */

import Link from 'next/link';
import type { IcBreadcrumbItem } from '@/lib/mock-data/admin/internal-incidents-data';

interface IcBreadcrumbProps {
  items: IcBreadcrumbItem[];
}

export function IcBreadcrumb({ items }: IcBreadcrumbProps) {
  return (
