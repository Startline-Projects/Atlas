/* fr-section-head pattern shared with Step 33/34 — sh-num chip + h2 + sh-meta + dashed separator */

import type { IcSectionHead as IcSectionHeadData } from '@/lib/mock-data/admin/internal-incidents-data';

interface IcSectionHeadProps {
  head: IcSectionHeadData;
}

export function IcSectionHead({ head }: IcSectionHeadProps) {
  return (
