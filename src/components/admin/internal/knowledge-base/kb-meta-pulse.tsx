/* admin.html line 66168: meta-pulse danger alert inline in fr-page-head meta line */

interface KbMetaPulseProps {
  html: string;
}

export function KbMetaPulse({ html }: KbMetaPulseProps) {
  return (
