...
export function DsrSubjectCardSection({ card }: DsrSubjectCardProps) {
    ...
    <div className="bg-[var(--paper)] border border-[var(--line)] rounded-[var(--r-md)] py-[16px] px-[18px]">
      ...
      <div className="flex items-center gap-[10px] mb-[12px]">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="font-mono text-[10px] text-[var(--ink-mute)] tracking-[0.04em] mt-[2px]">{card.subjectId}</div>
        </div>
      </div>
