...
import type { JobsFilterChip, JobFilterKey } from '@/lib/mock-data/admin/job-profiles-data';
import { cn } from '@/lib/utils/cn';

interface JobsToolbarProps {
  searchQuery: string;
  onSearchChange: (value: string) => void;
  selectedFilter: JobFilterKey;
  onFilterChange: (key: JobFilterKey) => void;
...
export function JobsToolbar({
  ...
  return (
    <>
      {/* admin.html line 22334: adm-toolbar (search) */}
      ...
      {/* admin.html line 22343: adm-toolbar (filter chips) */}
