...
import type { DisputesFilterChip, DisputeFilterKey } from '@/lib/mock-data/admin/dispute-profiles-data';
import { cn } from '@/lib/utils/cn';

interface DisputesToolbarProps {
  searchQuery: string;
  onSearchChange: (value: string) => void;
  selectedFilter: DisputeFilterKey;
  onFilterChange: (key: DisputeFilterKey) => void;
    ...
    <>
      <div className="flex items-center gap-[12px] mb-[16px] flex-wrap">
        <div className="flex-[1_1_280px] flex items-center gap-[8px] bg-[var(--paper)] border border-[var(--line)] rounded-[var(--r-md)] py-[8px] px-[14px] min-w-0">
          ...
          <input
            type="text"
            placeholder="Search by dispute ID, party name, or reason…"
